...
extern "C" {
    pub fn Fl_Flow_image(arg1: *const Fl_Flow) -> *const ::std::os::raw::c_void;
}
extern "C" {
...
extern "C" {
    pub fn Fl_Flow_deimage(arg1: *const Fl_Flow) -> *const ::std::os::raw::c_void;
}
extern "C" {
...
extern "C" {
    pub fn Fl_Flow_super_draw_first(ptr: *mut Fl_Widget, flag: ::std::os::raw::c_int);
}
extern "C" {
    pub fn Fl_Flow_rule(
        self_: *mut Fl_Flow,
