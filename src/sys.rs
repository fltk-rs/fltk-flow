...
extern "C" {
    pub fn Fl_Flow_set_damage_area(
        self_: *mut Fl_Flow,
...
extern "C" {
    pub fn Fl_Flow_super_draw(ptr: *mut Fl_Widget, flag: ::core::ffi::c_int);
}
extern "C" {
    pub fn Fl_Flow_super_draw_first(ptr: *mut Fl_Widget, flag: ::core::ffi::c_int);
}
extern "C" {
    pub fn Fl_Flow_super_handle_first(ptr: *mut Fl_Widget, flag: ::core::ffi::c_int);
}
extern "C" {
